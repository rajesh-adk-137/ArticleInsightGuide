...
//     tour.addStep({
//       id: 'article-summary',
//       text: 'Learn about our key features and benefits on this page.',
...
//     tour.addStep({
//       id: 'get-started',
//       text: 'Ready to get started? Click the button below.',
//       attachTo: { element: '.get-started-button', on: 'bottom' },
//       buttons: [
//         {
//           text: 'End Tour',
...
//                   <Link
//                     className="get-started-button inline-flex items-center justify-center rounded-md bg-gray-900 px-6 py-3 text-lg text-gray-50 shadow-lg transition-colors hover:bg-gray-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 disabled:pointer-events-none disabled:opacity-50"
//                     to='/home'
//                   >
//                     Get Started
//                   </Link>
...
export default function AboutPage() {
    ...
    useEffect(() => {
        ...
        const steps = [
            ...
            {
                id: 'key-features',
                text: 'These are the key features our app offers.',
                attachTo: { element: '.key-features', on: 'top' },
                buttons: [
                    {
                        text: 'Back',
                        action: tour.back
    ...
    return (
        <div className="flex flex-col min-h-[100dvh]">
            ...
            <button id="start-tour" className="fixed bottom-4 right-4 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-500 focus:outline-none">
                Start Tour
            </button>
        </div>
    );
