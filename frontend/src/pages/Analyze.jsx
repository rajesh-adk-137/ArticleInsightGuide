...
const Analyze = () => {
  ...
  const tour = new Shepherd.Tour({
    ...
    const steps = [
      {
        id: 'article-topic',
        text: 'This is the title that most resembles the article you submitted.',
      ...
      {
        id: 'tags',
        text: 'Here are the tags relevant to the article.',
      ...
      {
        id: 'article-summary',
        text: 'Here is a summary of the article that includes the key points in the article.',
      ...
      },
      {
        ...
        text: 'This section shows the sentiment analysis of the comments if any.',
      ...
      {
        id: 'question-input',
        text: 'You can ask a question related to the article here to our AI.',
  ...
  return (
    <div className="container mx-auto my-12 px-4 md:px-6 lg:px-8">
      <article className="prose">
        ...
        <div id="tags" className="mt-4 flex flex-wrap items-center gap-2">
          {uniqueTags.length > 0 &&
