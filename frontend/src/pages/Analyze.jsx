...
const Analyze = () => {
  ...
  useEffect(() => {
    ...
    const steps = [
      {
        id: 'article-topic',
        text: 'This is the topic of the article you submitted.',
      ...
      },
      {
        ...
        text: 'This section shows the sentiment analysis of the comments.',
        attachTo: { element: "#comment_sentiment", on: 'top' },
        buttons: [
          {
            text: 'Back',
            action: tour.back
      ...
      {
        id: 'question-input',
        text: 'You can ask a question related to the article here.',
        attachTo: { element: '.question-input', on: 'bottom' },
        buttons: [
          {
            text: 'Back',
            action: tour.back
      ...
      {
        id: 'ai-responses',
        text: 'This section displays the responses from the AI to your questions.',
  ...
  return (
    <div className="container mx-auto my-12 px-4 md:px-6 lg:px-8">
      <article className="prose">
        <h1 className="article-topic text-5xl font-bold tracking-tight text-black capitalize">
        ...
        <ul className="article-summary mt-6 text-xl text-gray-500 list-disc list-inside">
          {articleData?.summary?.map((item, index) => (
            <li key={index}>{item}</li>
          ))}
        </ul>
        <hr className="my-6 border-gray-300" />
        <h2 id="comment_sentiment" className="text-4xl font-bold tracking-tight text-black mt-10">Comment Sentiment Analysis</h2>
        <SentimentMessage sentiment={articleData?.sentiment?.sentiment?.[0]} className="comment-sentiment" />
      </article>
      <hr className="my-6 border-gray-300" />
      <section className="mt-12">
        ...
        <form className="mt-4 space-y-4" onSubmit={handleQuestionSubmit}>
          <div>
            ...
            <textarea
              className="question-input mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-lg text-gray-900 shadow-sm focus:border-gray-500 focus:outline-none focus:ring-gray-500 resize-none"
              id="question"
      ...
      <hr className="my-6 border-gray-300" />
      <section className="ai-responses mt-12">
...
//       id: 'article-topic',
//       text: 'This is the topic of the article you submitted.',
//       attachTo: { element: '.article-topic', on: 'bottom' },
//       buttons: [
//         {
//           text: 'Next',
//           action: tour.next
...
//       id: 'article-summary',
//       text: 'Here is a summary of the article.',
//       attachTo: { element: '.article-summary', on: 'bottom' },
//       buttons: [
//         {
//           text: 'Back',
//           action: tour.back
...
//       text: 'This section shows the sentiment analysis of the comments.',
//       attachTo: { element: '.comment-sentiment', on: 'bottom' },
//       buttons: [
//         {
//           text: 'Back',
//           action: tour.back
...
//       id: 'ai-responses',
//       text: 'This section displays the responses from the AI to your questions.',
//       attachTo: { element: '.ai-responses', on: 'bottom' },
//       buttons: [
//         {
//           text: 'Back',
//           action: tour.back
...
//     return () => {
//       document.getElementById('start-tour').removeEventListener('click', () => {
//         tour.start();
//       });
//     };
//   }, []);
